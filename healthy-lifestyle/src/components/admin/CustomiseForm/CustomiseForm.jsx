...
const CustomiseForm = () => {
    const initialQuestions = [
        ...
        { id: 3, text: 'Do you consume alcohol? If yes, since (years)?', answerType: 'text' },
      ];
    
      const [questions, setQuestions] = useState(initialQuestions);
      const [userAnswers, setUserAnswers] = useState({});
      const [newQuestion, setNewQuestion] = useState({ text: '', answerType: 'text' });
  ...
  return (
    ...
    <div style={{ display: "flex" }}>
      <AdminSidebar />
      <Box fontFamily={"Open Sans, sans-serif;"} p={5} width={"100%"}>
          {/* Top side */}
          <Flex 
          m={[5, 10, 15]}
            align="left"
